...
/** SdpField is a SDP field, formatted as separated SDP line.
  * It is formed by a 'type' (char) and a 'value' (String).
  * <p>
  * A SDP field is formatted as a separated SDP line of the form &lt;type&gt; = &lt;value&gt;
  */
public class SdpField {
	...
	/** Creates a new SDP field.
	  * @param sf the SDP field to be cloned */
	public SdpField(SdpField sf) {
		type=sf.type;
		value=sf.value;
	}

	/** Creates a new SDP field based on a SDP line of the form &lt;type&gt;=&lt;value&gt;.
	...
	/** Gets the field type.
	  * @return the type of the SDP field */
	public char getType() {
		return type;
	}
	
	/** Gets the field value.
	  * @return the value of the SDP field */
