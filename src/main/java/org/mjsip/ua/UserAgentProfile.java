...
public class UserAgentProfile extends Configure {
	 ...
	 * By default, the org.local folder "resources" is used. */
  public static String res_path="resources";
	...
	private void init() {
		...
		if (media_desc_vector.size()==0 && audio) {
			media_desc_vector.addElement(MediaDesc.parseMediaDesc("video 9078 RTP/AVP { video 96 H264 90000 }"));
//			media_desc_vector.addElement(MediaDesc.parseMediaDesc("audio 9088 RTP/AVP { audio 0 PCMU 8000 160 }"));
//			media_desc_vector.addElement(MediaDesc.parseMediaDesc("audio 9088 RTP/AVP { audio 8 PCMA 8000 160 }"));
			media_desc_vector.addElement(MediaDesc.parseMediaDesc("audio 9088 RTP/AVP { audio 97 OPUS 48000}"));
//			media_desc_vector.addElement(MediaDesc.parseMediaDesc("audio 9098 RTP/AVP { audio 0 PCMU 8000 160, audio 8 PCMA 8000 160 }"));
		}
	...
	/** Gets the user's AOR (Address Of Record) registered to the registrar server
	  ...
	  * otherwhise the org.local UA address (obtained by the SipProvider) is used.
