...
public class RtpReceiver {
	...
	/** Creates a new RtpReceiver.
	  * @param udp_socket the org.local UDP socket used for receiving RTP packets
	...
	/** Inits the RtpReceiver.
	  * @param socket the org.local UDP socket used for receiving RTP packets
