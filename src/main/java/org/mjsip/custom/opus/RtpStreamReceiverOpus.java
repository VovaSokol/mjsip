...
/** RtpStreamReceiver is a generic RTP receiver.
  ...
  */
public class RtpStreamReceiverOpus extends Thread implements RtpControlledReceiver {
	...
	/** The OutputStream */
	OpusOutputStream output_stream=null;
	...
	/** Constructs a RtpStreamReceiver.
	  ...
	  * @param local_port the org.local receiver port */
	public RtpStreamReceiverOpus(OpusOutputStream output_stream, Encoder additional_decoder, int local_port) throws java.net.SocketException {
	...
	//public RtpStreamReceiver(OpusOutputStream output_stream, int local_port, RtpStreamReceiverListener listener)
	...
	/** Constructs a RtpStreamReceiver.
	  * @param output_stream the stream sink
	  * @param additional_decoder additional RTP payload decoder (optional)
	  * @param socket the org.local receiver UdpSocket */
	public RtpStreamReceiverOpus(OpusOutputStream output_stream, Encoder additional_decoder, UdpSocket socket) {
	...
	/** Constructs a RtpStreamReceiver.
	  ...
	  * @param socket the org.local receiver UdpSocket
	  * @param listener the RtpStreamReceiver listener */
	public RtpStreamReceiverOpus(OpusOutputStream output_stream, Encoder additional_decoder, UdpSocket socket, RtpStreamReceiverListener listener) {
	...
	private void init(OpusOutputStream output_stream, Encoder additional_decoder, int local_port, RtpStreamReceiverListener listener) throws java.net.SocketException {
	...
	/** Inits the RtpStreamReceiver.
	  ...
	  * @param socket the org.local receiver UdpSocket
	  * @listener the RtpStreamReceiver listener */
	private void init(OpusOutputStream output_stream, Encoder decoder, UdpSocket udp_socket, RtpStreamReceiverListener listener) {
...
//						}
					...
					if (remote_soaddr==null || !remote_soaddr.equals(source_soaddr)) {
						...
						if (listener!=null) listener.onRemoteSoAddressChanged(null,remote_soaddr);
					}
				}
		...
		if (listener!=null) listener.onRtpStreamReceiverTerminated(null,error);
	}
