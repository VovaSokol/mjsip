...
/** SIP Header Proxy-Require.
	*/
public class ProxyRequireHeader extends OptionTagsHeader {
	...
	public ProxyRequireHeader(String[] option_tags) {
		super(SipHeaders.Proxy_Require,option_tags);
	}

	/** Creates a new ProxyRequireHeader.
	  * @param option_tag a single option-tag or a comma-separated list of option-tags. */
	public ProxyRequireHeader(String option_tag) {
		super(SipHeaders.Proxy_Require,option_tag);
	}
