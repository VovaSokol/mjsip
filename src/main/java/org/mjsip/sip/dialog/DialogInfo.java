...
/** Class DialogInfo maintains a complete state information of a SIP dialog.
  ...
  * <ul>
  * <li>org.local and remote URIs</li>
  * <li>org.local and remote contact URIs</li>
  * <li>call-id</li>
  * <li>org.local and remote tags</li>
  * <li>org.local and remote cseqs</li>
  * <li>route set</li>
...
public class DialogInfo/* extends org.zoolu.util.MonitoredObject*/ {
	...
	/** Sets the org.local CSeq number. */
	public void setLocalCSeq(long cseq) { local_cseq=cseq; }
	/** Increments the org.local CSeq number. */
	public void incLocalCSeq() { local_cseq++; }
	/** Gets the org.local CSeq number. */
