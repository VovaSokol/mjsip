...
public class ServerProfile extends Configure {
	...
	/** Whether consider any port as valid org.local domain port
	...
	/** Whether the Server relays requests for (or to) non-org.local users. */
	public boolean is_open_proxy=true;
	/** The type of location service.
	  * You can specify the location service type (e.g. org.local, ldap, radius, mysql)
	  * or the class name (e.g. org.local.server.LocationServiceImpl). */
	public String location_service= "org/local";
	...
	/** Whether the Server authenticates org.local users. */
	...
	/** The authentication scheme.
	  ...
	  * or the class name (e.g. org.local.server.AuthenticationServerImpl). */
	...
	/** The type of authentication service.
	  * You can specify the authentication service type (e.g. org.local, ldap, radius, mysql)
	  * or the class name (e.g. org.local.server.AuthenticationServiceImpl). */
	public String authentication_service= "org/local";
